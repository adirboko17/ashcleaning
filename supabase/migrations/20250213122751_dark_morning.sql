/*
  # Initial schema setup with test data

  1. Tables
    - users: Store user accounts (admin, employees, clients)
    - branches: Store client branches
    - jobs: Store cleaning jobs
...
BEGIN
  ...
  VALUES ('0501234567', 'admin123', 'מנהל מערכת', 'admin')
  RETURNING id INTO admin_id;

  -- Insert test client
  INSERT INTO users (phone_number, password, full_name, role)
  VALUES ('0502222222', 'client123', 'לקוח לדוגמה', 'client')
  RETURNING id INTO client_id;

  -- Insert test employee
  INSERT INTO users (phone_number, password, full_name, role)
  VALUES ('0503333333', 'emp123', 'עובד לדוגמה', 'employee')
