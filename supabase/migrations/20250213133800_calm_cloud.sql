/*
  # Fix branches table foreign key
  
  1. Changes
    - Update branches table to correctly reference users table
    - Re-create test data with correct references
*/
...
-- Create branches table with correct foreign key
